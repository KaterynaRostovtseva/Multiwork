...
import Clouse from "../assets/icons/Clouse.svg";
    ...
    return (
        <Container component="main" maxWidth="xs">
            <Box display="flex" flexDirection="column" alignItems="center" textAlign="center"
                ...
                <Box component="img" src={Clouse} sx={{ width: '160px', height: '160px', textAlign: 'center' }} />
                <Typography variant="h6" component="h2" gutterBottom sx={{ ...textStylesH2, color: '#F97066', margin:'24px 0' }}>
                     You have declined the invitation to the project  {project?.title}
                </Typography>
