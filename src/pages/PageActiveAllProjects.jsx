...
const PageActiveAllProjects = () => {
    ...
    const activeProjects = dataAllProjects
        .filter(i => i.project_status === 'Active')
        .filter(project => {
    ...
    const currentData = activeProjects.slice(
        ...
        <Grid container sx={{ display: 'flex', flexDirection: { xs: 'column', md: 'row' }, marginTop: '-108px' }}>
            ...
            <Grid sx={{ flex: 1, margin: { xs: '138px 16px 0 16px', md: '138px 80px 80px 80px' } }}>
                <Grid sx={{ display: 'flex', justifyContent: 'space-between', flexDirection: { xs: 'column', md: 'row' } }}>
                    <Typography sx={{ ...textStylesH2, marginBottom: '40px' }}>Active projects</Typography>
...
export default PageActiveAllProjects;
