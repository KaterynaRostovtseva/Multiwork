...
function CardData(prop) {
  ...
  return (
    <Grid container >
      <Card sx={{ boxShadow: '0 4px 15px 0 rgba(16, 24, 40, 0.05)', borderRadius: '12px', width: '334px', minHeight: "400px", padding: '8px', flexDirection: "column", }}>
      ...
      <CardContent sx={{ flexGrow: 1, display: "flex", flexDirection: "column", }}>
        <Box>
          <Typography component="span" sx={{ ...textStylesBody2, marginTop: '16px', textAlign: 'left', height: '50px', display: '-webkit-box', WebkitBoxOrient: 'vertical', overflow: 'hidden', WebkitLineClamp: 2, textOverflow: 'ellipsis', }}>
        ...
        <Grid sx={{ display: "flex", gap: "12px" }}>
          ...
          <Button sx={{ ...buttonStyles, borderRadius: '4px', padding: '10px 18px', width: '100%', height: '44px', color: '#0A0A0A', border: '1px solid #0A0A0A' }}>Hide</Button>
      ...
      <DeleteModal isOpen={isModalOpen} onClose={handleCloseModal} onDelete={() => handleDelete(selectedProjectId)} />
    </Card>
    </Grid >
  );
}
